...
void CPPLox::TokenScanner::scanToken() {
    ...
    case '\n':
        ...
        break;
    case '(':
        this->lockToken(TokenType::LEFT_PAREN);
        break;
    case ')':
        this->lockToken(TokenType::RIGHT_PAREN);
        break;
    case '{':
        this->lockToken(TokenType::LEFT_BRACE);
        break;
    case '}':
        this->lockToken(TokenType::RIGHT_BRACE);
        break;
    case ',':
        this->lockToken(TokenType::COMMA);
        break;
    case '.':
        this->lockToken(TokenType::DOT);
        break;
    case '-':
        this->lockToken(TokenType::MINUS);
        break;
    case '+':
        this->lockToken(TokenType::PLUS);
        break;
    case ';':
        this->lockToken(TokenType::SEMICOLON);
        break;
    case '*':
        this->lockToken(TokenType::STAR);
        break;
    case '!':
        this->match('=') ? this->lockToken(TokenType::BANG_EQUAL)
                         : this->lockToken(TokenType::BANG);
        break;
    case '=':
        this->match('=') ? this->lockToken(TokenType::EQUAL_EQUAL)
                         : this->lockToken(TokenType::EQUAL);
        break;
    case '<':
        this->match('=') ? this->lockToken(TokenType::LESS_EQUAL)
                         : this->lockToken(TokenType::LESS);
        break;
    case '>':
        this->match('=') ? this->lockToken(TokenType::GREATER_EQUAL)
                         : this->lockToken(TokenType::GREATER);
        break;
    case '/':
        if (this->match('/')) {
            while (this->peek() != '\n' && !this->isAtEnd())
